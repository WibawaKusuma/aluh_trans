<!-- <div class="slider-area ">
    <div class="single-slider slider-height2 d-flex align-items-center"
        data-background="<?= base_url('assets/template') ?>/img/hero/image3.jpg">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
...
<section class="contact-section">
    <div class="container">
        <div class="d-none d-sm-block mb-5 pb-4">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d467.04779617820344!2d115.14078705889946!3d-8.53096211304665!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd23b002249c197%3A0x3e829dc0ac287815!2sPatung%20Gajah%20Griya%20Multi%20Jadi!5e1!3m2!1sid!2sid!4v1730432115984!5m2!1sid!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            <div id="map" style="height: 480px; position: relative; overflow: hidden;" hidden>
                <div
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="contact-title font">Get in Touch</h2>
            </div>
            <div class="col-lg-8">
                <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm"
                    ...
                    <div class="form-group mt-3">
                        <button type="submit" class="button button-contactForm boxed-btn font">Send</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-3 offset-lg-1">
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3 class="font">Bali, Indonesia.</h3>
                        <p class="font">Alamat, Perum Griya Multi Jadi, Kediri, Tabanan</p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                    <div class="media-body">
                        <h3 class="font">+1 253 565 2365</h3>
                        <p class="font">Monday to Friday <br> 9am to 6pm</p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="ti-email"></i></span>
                    <div class="media-body">
                        <h3 class="font">support@ajikpo.com</h3>
                        <p class="font">Send us your query anytime!</p>
                    </div>
                </div>
            </div>
        </div>
